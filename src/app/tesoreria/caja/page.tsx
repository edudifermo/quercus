...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Tesorería · Caja"><PlaceholderModule title="Tesorería · Caja" description="Movimientos de caja por especie, moneda y consolidación." /></ErpShell>;
}
