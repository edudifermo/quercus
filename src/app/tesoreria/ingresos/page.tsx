...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Tesorería · Ingresos / Cobranzas"><PlaceholderModule title="Tesorería · Ingresos / Cobranzas" description="Registro de cobranzas sin generación de deuda." /></ErpShell>;
}
