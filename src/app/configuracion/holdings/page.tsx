...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Configuración · Holdings / grupos"><PlaceholderModule title="Configuración · Holdings / grupos" description="Definición de grupos de consolidación multiempresa." /></ErpShell>;
}
