...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Contabilidad · Libro mayor"><PlaceholderModule title="Contabilidad · Libro mayor" description="Mayor por cuenta, empresa y período." /></ErpShell>;
}
