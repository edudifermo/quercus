...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Contabilidad · Plan de cuentas"><PlaceholderModule title="Contabilidad · Plan de cuentas" description="Plan contable multiempresa y asignación por compañía." /></ErpShell>;
}
