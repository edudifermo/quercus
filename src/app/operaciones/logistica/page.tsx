...
export default async function Page({ searchParams }: { searchParams?: Promise<{ company?: string; user?: string; group?: string }> }) {
  ...
  return <ErpShell context={context} title="Operaciones · Logística"><PlaceholderModule title="Operaciones · Logística" description="Expedición, recepciones y trazabilidad operativa." /></ErpShell>;
}
